...
<table style="font-family:Helvetica,Arial;line-height:1.6;">
  ...
  <td style="border:0;padding:0;vertical-align:text-top;">
    This repository gathers <a href="https://dart.dev/" rel="external">Erlang</a> code examples coming from various websites - mostly from the <a href="https://erlang.org/" rel="external">Erlang</a> project - or written by ourself.<br/>
...
We execute command [**`setenv.bat`**](setenv.bat) once to setup our development environment; it makes external tools such as [**`git.exe`**][git_cli] and [**`sh.exe`**][sh_cli] directly available from the command prompt.
   ...
   Tool versions:
      erl 15.2.7.3, dialyzer v5.3.1, make 4.4.1
      elvis 4.0.0, code 1.105.1,
...
<pre style="font-size:80%;">
<a href="https://github.com/inaka/elvis/releases/tag/4.0.0" rel="external">elvis</a> (<i>escript</i>)                   <i>(2.4 MB)</i>
<a href="https://github.com/erlang/otp/releases/tag/OTP-27.3.4.4" rel="external">otp_win64_27.3.4.4.exe</a>            <i>(133 MB)</i>
...
[elvis_relnotes]: https://github.com/inaka/elvis/releases/tag/4.0.0
[erlang]: https://erlang.org/
[erlang_changelog]: https://github.com/erlang/otp/releases/tag/OTP-27.3.4.4
